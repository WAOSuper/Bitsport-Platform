...
@section('content')
    ...
    <div class="content">
        ...
        <form class="register-form" action="{{ url('register') }}" method="post">
            ...
            <input type="hidden" name="is_sponser" value="yes">
            ...
            <div class="form-group" style="display:none">
                ...
                <div class="input-icon">
                    <i class="fa fa-font"></i>
                    <input class="form-control placeholder-no-fix" value="NA" type="text" placeholder="PSN ID / Xbox Gamertag" name="sponser" /> </div>
            </div>
            ...
            <div class="create-account">
                <p> Have an account ?&nbsp;
                    <a href="{{ url('login') }}" id="register-btn"> Login </a>
                </p>
            </div>
        </form>
