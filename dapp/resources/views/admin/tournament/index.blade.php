                            ...
                            <tr>
                                ...
                                <td width="20%">
                                    ...
                                    @if($tournament->status == 1)
                                     <a href="{{ url('changetournamentStatus/'.$tournament->id.'/0') }}" class="btn btn-danger" >Deactivate</a>
                                    @else
                                      <a href="{{ url('changetournamentStatus/'.$tournament->id.'/1') }}" class="btn btn-success" >Active</a>
                                    @endif
