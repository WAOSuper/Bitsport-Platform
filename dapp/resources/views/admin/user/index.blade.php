                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                            ...
                            <tr>
                                ...
                                <td width="18%">
                                    @if($user->user->status == 0)
                                     <a href="{{ url('changeUserStatus/'.$user->user->id.'/1') }}" class="btn btn-success" >Active</a>
                                    @else
                                      <a href="{{ url('changeUserStatus/'.$user->user->id.'/0') }}" class="btn btn-danger" >Block</a>
                                    @endif
                                    <a href="{{ url('edit-preference/'.$user->user->id) }}" class="btn btn-primary" >Edit Preference</a>
                                </td>
                            </tr>
                            @endif
                            @endforeach
