    ...
    <!-- BEGIN CONTENT BODY -->
	    <div class="page-content" style="min-height: 1603px;">
	        ...
	        <ul class="page-breadcrumb breadcrumb">
	            ...
	            <li>
	                <span class="active">Insert CMS</span>
	            </li>
	        </ul>
	        <!-- END PAGE BREADCRUMB -->
	                ...
	                <div class="portlet light bordered">
	                    <div class="portlet-title">
	                        <div class="caption font-blue-sunglo">
	                            ...
	                            <span class="caption-subject bold uppercase"> Insert CMS</span>
	                        </div>
	                        ...
	                        <form role="form" method="post" action="{{route('admin-cms.store')}}" enctype="multipart/form-data">
	                            ...
	                            <div class="form-body">
	                                ...
	                                <div class="form-group {{ $errors->has('content') ? ' has-error' : '' }}">
	                                    ...
	                                    <textarea name="content" class="form-control ckeditor" id="ckeditor"  rows="10">{{ old('content') }}</textarea>
