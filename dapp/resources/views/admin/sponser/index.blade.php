...
<div class="page-content-wrapper">
    ...
    <div class="page-content" style="min-height: 1489px;">
        ...
        <ul class="page-breadcrumb breadcrumb">
            ...
            <span class="set-right"><a href="{{route('admin-sponser.create')}}" class="btn btn-primary ">Add Sponser Link</a></span>
        </ul>
        <!-- END PAGE BREADCRUMB -->
        <div class="row">
                          ...
                          @foreach($sponser as $cat)
                            <tr>
                                ...
                                <td width="250">
										...
										<a href="{{ route('admin-sponser.edit',$cat->id) }}" class="btn btn-xs blue"  ><i class="fa fa-pencil"></i></a>

                                        @if($cat->status == 0)
                                        <a href="{{ route('admin-sponser.deactivestatus',$cat->id) }}" class="btn btn-danger" >Deactivate</a>
                                        @endif
                                        @if($cat->status == 1)
                                        <a href="{{ route('admin-sponser.activestatus',$cat->id) }}" class="btn btn-success" >Active</a>
                                        @endif
