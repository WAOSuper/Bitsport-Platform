            ...
            <div class="row">
                    ...
                    <div class="dashboard-stat2 bordered">
                        <div class="display">
                            <div class="number">
                                ...
                                <small>THIS WEEK NEED BETS</small>
                            </div>
                            <div class="icon">
                        ...
                        <div class="display">
                            <div class="number">
                                <h3 class="font-red-haze">
                                    <span data-counter="counterup" data-value="{{ $bet->count() }}">0</span>
                                </h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat2 bordered">
                        <div class="display">
                            <div class="number">
                                <h3 class="font-blue-sharp">
                                    <span data-counter="counterup" data-value="{{$week_users}}"></span>
                                </h3>
                                <small>THIS WEEK USERS</small>
                            </div>
                            <div class="icon">
                        ...
                        <div class="progress-info">
                            <div class="progress">
                                        <span style="width: {{$week_users}}%;" class="progress-bar progress-bar-success blue-sharp">
                                            <span class="sr-only">{{$week_users}}% grow</span>
                                        </span>
                            </div>
                            <div class="status">
                                <div class="status-title"> grow </div>
                                <div class="status-number"> {{$week_users}}% </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat2 bordered">
                        <div class="display">
                            <div class="number">
                                <h3 class="font-purple-soft">
                                    <span data-counter="counterup" data-value="{{$new_users}}"></span>
                                </h3>
                        ...
                        <div class="progress-info">
                            <div class="progress">
                                        <span style="width: {{$new_users}}%;" class="progress-bar progress-bar-success purple-soft">
                                            <span class="sr-only">{{$new_users}}% change</span>
                                        </span>
                            </div>
                            <div class="status">
                                <div class="status-title"> change </div>
                                <div class="status-number"> {{$new_users}}% </div>
                            </div>
                        </div>
                    </div>
                </div>
