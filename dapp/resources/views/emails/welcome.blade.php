...
<head>
    <meta charset="utf-8">
    <title>Welcome to BitSport</title>
</head>
<body>
							...
							<tr>
								<td>
									...
									<table width="50%" align="left" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td align="left">
												<a href="https://bitsport.gg" class="editable-img">
							...
							<tr>
								<td mc:edit="text003" align="left" class="text_color_282828" style="color: #282828; font-size: 15px; line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												Congratulations {{ $user->first_name }} and thanks for joining one of the first ever Blockchain driven competitive eSports platforms. <br><br>

												Gaming is fun, our goal is to make it lucrative as well so you can earn real money and value (and not worthless virtual coins) doing what you love. <br><br>

												<h3>Here are things to do on BitSport to spice up your gaming life.</h3>

												We have packaged several activities which you can participate with other gamers around the world to start earning while gaming.<br><br>


												<h3>Host a Peer to Peer Match</h3>

													Peer to Peer matches are a great way to put your gaming skills to work to maximize your earning potential on BitSport. Peer to peer matches allows other users to bank on your skills as well creating a win-win situation for you and your backers.  <br><br>

													<h3>Host a Challenge</h3>

													Think you have what it takes to defeat anyone in a challenge, while not host a challenge with money on the line, defeat your opponent and increase your worth. It's that simple.  <br><br>

													<h3>Participate in a Tournament</h3>

													Do you feel a sense of superiority amongst the clan? - take your skills for a ride by joining a tournament on BitSport, lead the pack, earn the reward, rinse and repeat.  <br><br>

													<h3>Stake on Curated Gaming Events</h3>

													You don't want to be in the frontline but feel the need to increase your worth in the gaming space? why not put a stake on that gamer you vouch for while they participate in a curated match or gaming event.  <br><br>


													What are you waiting for? it's about time to start increasing your worth - Gaming.
										...
										<tr>
											<td mc:edit="text004" align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_ffffff">
												<div class="editable-text">
													<span class="text_container">
														<multiline>
															<a href="https://www.bitsport.io/" style="text-decoration: none; color: #ffffff;">Let's Start</a>
														</multiline>
													</span>
												</div>
											</td>
