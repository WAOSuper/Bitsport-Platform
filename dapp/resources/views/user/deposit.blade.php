                ...
                <div class="col-lg-12 col-xs-12 col-sm-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption font-blue-sunglo">
                                ...
                                <span class="caption-subject bold uppercase"> Deposit {{$coin}}</span>
                            </div>
                            <div>
                        ...
                        <div class="portlet-body">
                             ...
                             <?php if($coin == 'paypal'): ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <form id="paypalForm" name="paypalform" method="post" action="{{ url('/') }}/paypal-create" >
                                            ...
                                            <label>Amount</label>
                                            <input class="form-control" name="amount" type="text" size="40"  required/>
                                            </div>
                                            </div>  
                                            <div class="col-md-6">
                                                <select class="payment-units" id="PAYMENT_UNITS" name="PAYMENT_UNITS">
                            ...
                            <?php endif; ?>
                             ...
                             <div class="row">
                                 <div class="col-lg-12 pull-left" >
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <form id="epayForm" name="form1" method="post" action="https://api.epay.com/paymentApi/merReceive" >
                                                ...
                                                {{-- <input name="PAYEE_ACCOUNT" type="hidden" value="devanshugupta28@gmail.com" size="40" /> --}}

                                                {{-- <input name="PAYEE_ACCOUNT" type="hidden" value="gdevanshu05@gmail.com" size="40" /> --}}
                                    ...
                                    <input type="text" value="{{$add->address}}" class="form-control" name="" style="height: 45px;" readonly></div>
                    ...
                    <li> Remember: CHECK the FIRST 4 characters and the LAST 4 characters of the Bitcoin address when you PASTE it elsewhere</li>
                     <li>Important: This deposit address is for BitCoin (BTC) only. We will not refund an incorrect Deposit.          </li>
                            ...
                            <?php endif; ?>
                            @if ($coin != 'EPAY' && $coin != 'paypal' && $coin != 'BTP')
                            <button type="button" class="btn btn-info pull-left" data-toggle="modal" data-target="#get_transaction">Don't Receive Your Deposit</button>
