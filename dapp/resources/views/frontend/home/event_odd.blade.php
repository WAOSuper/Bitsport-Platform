                ...
                <div class="event-third">
                    ...
                    <div class="bottom-img">
                       <!--  <img src="https://www.nassm.com/sites/default/files/randomslide/15.jpg" width="100%"> -->
                         ...
                         ?>
                             <iframe width="100%" height="315" src="https://player.twitch.tv/?channel=<?php echo $whatIWant; ?>&parent=bitsport.gg" frameborder="0" allowfullscreen> </iframe>
                        <?php } else {
                            if($match && $match->twitch_url) {
                                $whatIWant = substr($match->twitch_url, strpos($match->twitch_url, "tv/") + 3);
                        ?>
                             <iframe width="100%" height="315" src="https://player.twitch.tv/?channel=<?php echo $whatIWant; ?>&parent=bitsport.gg" frameborder="0" allowfullscreen> </iframe>
                        <?php 
                            }
                  ...
                  <div class="card">
                    ...
                    @if(@$team_data->Team1)
                      ...
                      <div class="card-body row">
                        <div class="col-md-4">
                          <input type="checkbox" class="hidden">
                            <div class="bg-color" onclick="update_odd(this)" odd-select="1" odd-val="{{$eventmaster->livep2pevents[0]->odds}}" odd-id="{{$eventmaster->id}}" odd-name1="{{ $eventmaster->livep2pevents[0]->P2PTeam1->username }}" odd-name2="{{ $eventmaster->livep2pevents[0]->P2PTeam2->username }}" odd_title="Match Winner"">
                                <a href="#" class="box-collapse"> {{ @$eventmaster->livep2pevents[0]->P2PTeam1->username }}</a>
                                <span class="odd1">{{ number_format($eventmaster->livep2pevents[0]->odds,2) }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <input type="checkbox" class="hidden">
                            <div class="bg-color"   onclick="update_odd(this)" odd-select="2" odd-val="{{$eventmaster->livep2pevents[0]->draw}}" odd-id="{{$eventmaster->id}}" odd-name1="{{ $eventmaster->livep2pevents[0]->P2PTeam1->username }}" odd-name2="{{ $eventmaster->livep2pevents[0]->P2PTeam2->username }}" odd_title="Match Winner">
                                <a href="#" class="box-collapse"> Draw</a>
                                <span class="draw">{{ number_format($eventmaster->livep2pevents[0]->draw,2) }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                           <input type="checkbox" class="hidden"> 
                           <div class="bg-color"   onclick="update_odd(this)" odd-select="3" odd-val="{{$eventmaster->livep2pevents[0]->odds2}}" odd-id="{{$eventmaster->id}}" odd-name1="{{ $eventmaster->livep2pevents[0]->P2PTeam1->username }}" odd-name2="{{ $eventmaster->livep2pevents[0]->P2PTeam2->username }}" odd_title="Match Winner">
                                <a href="#" class="box-collapse"> {{ @$eventmaster->livep2pevents[0]->P2PTeam2->username }}</a>
                                <span class="odd2">{{ number_format($eventmaster->livep2pevents[0]->odds2,2) }}</span>
                            </div>
                        </div>
                      </div>
                      @endif
