...
@endif
  ...
  //  console.log(localStorage.betting);     
    ...
    function update_odd(elem){
        //  console.log(elem);
        console.log('update_odd test console....................');
    ...
    function new_odds(elem){
        ...
        console.log('new_odds test console....................');
        ...
        function(data, status){
            console.log('return from mybets test console....................');
...
function update_cart(odd_select,odd_val,odd_id,odd_name1,odd_name2,team,odd_name=null, odd_title, more_id)    {
    console.log('update_cart test console....................');
...
function remove_from_cart(id){
    console.log('remove_from_cart test console....................');
