...
class TournamentController extends Controller
{
    public function getTournament($id)
    {
        ...
        return view('frontend.tournament.index', compact('user', 'tournament', 'balance', 'bets', 'participants', 'participant_count', 'already_participant'));
    }
              ...
              if(isset($match[0]) && isset($match[1])) {
                ...
                Mail::send('emails.participant',[
                  ...
                  'tournament' => $tournament,
                     ...
                     $message->subject("Congrats! Your match is make for Tournament");
                 });
