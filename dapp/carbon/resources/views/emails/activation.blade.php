							...
							<tr>
								<td mc:edit="text003" align="left" class="text_color_282828" style="color: #282828; font-size: 15px; line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
									<div class="editable-text" style="line-height: 2;">
										<span class="text_container">
											<multiline>
												Congratulation {{ $user->first_name }}, you sucessfully got yourself a shiny new BitSport account. BitSport is one of the first ever decentralized competitive eSports platform. <br><br>

												There are fun things you can do on BitSport to start earning while you Play: <br><br>

												<h3>BitSport Open Online FUT Tournament - $10,000 Prize Pool</h3>

												Participate in the BitSport Open Online FUT tournament (Season 1) and stand a chance to be amoung the winners of a $10,000 Prize Pool, Cash reedemable BTP coins and lots of FIFA Points.<br><br>


												<h3>Become a Curator</h3>

													BitSport is a community driven eSports platform which allow gamers from all sphere of life to come together in making real and transparent decisions about their favorite games and eSport personalities<br><br>

													Becoming a curator allows you to earn while following and curating several live events ranging from tournaments, exhibitions and championships. <br><br>
										...
										<tr>
											<td mc:edit="text004" align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;" class="text_color_ffffff">
												<div class="editable-text">
													<span class="text_container">
														<multiline>
															<a href="https://www.bitsport.io/profile" style="text-decoration: none; color: #ffffff;">Become a Curator</a>
														</multiline>
													</span>
												</div>
											</td>
