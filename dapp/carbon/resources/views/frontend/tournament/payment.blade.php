...
<div class="content col-md-9">
  ...
  <div class="col-md-12">
      ...
      <p>Entry Fees: {{$tournament->fees}} BTP | (${{$tournament->fees * 0.18}})  </p>
      <ul class="nav custom-tab nav-tabs">
          <li class="active"><a data-toggle="tab" href="#paycard"><span> <img src="{{url('/')}}/assets/images/paybycard-b.png"></span> Pay by Card</a></li>
      ...
      <div class="tab-content">
        <div id="paycard" class="tab-pane fade active in">
             <div class="by-card">
