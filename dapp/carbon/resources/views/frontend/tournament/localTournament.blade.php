    ...
    <div class="payment-div">
      <form id="stripe-form" action="/stripe-payment" method="POST">
        ...
        {{-- <script src="https://checkout.stripe.com/checkout.js" class="stripe-button" data-key="{{env('STRIPE_PUB_KEY')}}"
          data-name="BitSport" data-amount="{{$tournament->fees * 180}}" data-name="Stripe Demo" data-description="Tournament joining fees"
        ...
        <input type="hidden" name="partner_center" value="<?php echo isset($_POST['partner_center']) ? $_POST['partner_center'] : '';?>">
      </form>
