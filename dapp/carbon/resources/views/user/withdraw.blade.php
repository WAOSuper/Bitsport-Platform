                    ...
                    <div class="portlet-body">
                       ...
                       <br>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" required autocomplete="off" placeholder="Wallet Address" name="coin_address" id="addres">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-footer">No Pending Withdraw {{$coin_name}} transactions found.</div>
                        </div>
