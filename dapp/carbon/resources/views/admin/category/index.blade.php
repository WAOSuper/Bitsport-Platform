                            ...
                            <tr>
                                ...
                                @endif
                                  <td width="250">
                                        ...
                                        @if($cat->status == 0)
                                        <a href="{{ route('admin-category.deactivestatus',$cat->id) }}" class="btn btn-danger" >Deactivate</a>
                                        @endif
                                        @if($cat->status == 1)
                                        <a href="{{ route('admin-category.activestatus',$cat->id) }}" class="btn btn-success" >Active</a>
                                        @endif
