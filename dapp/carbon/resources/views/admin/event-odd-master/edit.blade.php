              ...
              <div class="col-md-10 ">
                  ...
                  <div class="portlet light bordered">
                      ...
                      <div class="portlet-body form">
                           {{ Form::model($event_odd_master, array('route' => array('admin-event-odd-master.update', $event_odd_master->id), 'method' => 'PUT')) }}
                              <input type="hidden" name="_token" value="{{csrf_token()}}">
                              <div class="form-body">
                                  <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                      <label>Odd-Masters Title</label>
                                      <input type="text" class="form-control" placeholder="Enter Odd-Masters title" name="title" value="{{$event_odd_master->title}}">
                                      @if ($errors->has('title'))
