...
$image_logo = $options->get( 'image_three_logo' );
            ...
            <div class="container">
                <div class="main-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><a href="<?php echo( home_url( '/' ) ); ?>"><?php echo appway_logo( $logo_type, $image_logo, $logo_dimension, $logo_text, $logo_typography ); ?></a></figure>
                    </div>
...
<?php if( $options->get( 'quote_v5' ) ):?> 					
                        <div class="btn-box"><a href="<?php echo esc_url($options->get('quote_link_v5' ));?>"><?php echo wp_kses( $options->get( 'quote_v5'), $allowed_html ); ?></a></div>
					<?php endif; ?>		<?php endif; ?>	
                    </div>
                </div>
            </div>
        ...
        <div class="sticky-header">
            <div class="container clearfix">
                <figure class="logo-box"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo appway_logo( $logo_type, $small_logo, $logo_dimension, $logo_text, $logo_typography ); ?></a></figure>
                <div class="menu-area">
