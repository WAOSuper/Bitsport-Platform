            ...
            <div class="container">
                <div class="main-box clearfix">
                    <div class="logo-box pull-left">
                        <figure class="logo"><?php echo appway_logo( $logo_type, $small_logo, $logo_dimension, $logo_text, $logo_typography ); ?></figure>
                    </div>
					...
					<?php if( $options->get( 'quote_show_v4' ) ):?>
<?php if( $options->get( 'quote_v4' ) ):?>					
                        <div class="btn-box"><a href="<?php echo esc_url($options->get('quote_link_v4' ));?>"><?php echo wp_kses( $options->get( 'quote_v4'), $allowed_html ); ?></a></div>
					<?php endif; ?>		<?php endif; ?>		
                    </div>
                </div>
            </div>
