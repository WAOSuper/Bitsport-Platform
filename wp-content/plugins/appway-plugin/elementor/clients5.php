 ...
 * @since 1.0.0
 */
class Clients5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Clients 5', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'clients5',
			[
				'label' => esc_html__( 'Clients 5', 'appway' ),
			]
		);
    ...
    <!-- clients-section -->
    <section class="clients-section home-12 <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="sec-title">
