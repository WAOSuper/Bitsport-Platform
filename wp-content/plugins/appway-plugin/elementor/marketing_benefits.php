 ...
 * @since 1.0.0
 */
class Marketing_Benefits extends Widget_Base {
	...
	public function get_name() {
		return 'appway_marketing_benefits';
	}
	...
	public function get_title() {
		return esc_html__( 'Marketing Benefits', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'marketing_benefits',
			[
				'label' => esc_html__( 'Marketing Benefits', 'appway' ),
			]
		);
