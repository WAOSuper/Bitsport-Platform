 ...
 * @since 1.0.0
 */
class Solution_Text_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_solution_text_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Solution Text Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'solution_text_left',
			[
				'label' => esc_html__( 'Solution Text Left', 'appway' ),
			]
		);
	$this->add_control(
			'title',
                            ...
                            <div class="content_block_32">
                                <div class="content-box wow fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                                    <div class="icon-box">
										...
										<figure class="icon"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
										<?php endif; ?>
