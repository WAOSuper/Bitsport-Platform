 ...
 * @since 1.0.0
 */
class Social_Fundraising extends Widget_Base {
	...
	public function get_name() {
		return 'appway_social_fundraising';
	}
	...
	public function get_title() {
		return esc_html__( 'Social Fundraising', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'social_fundraising',
			[
				'label' => esc_html__( 'Social Fundraising', 'appway' ),
			]
		);
    ...
    <!-- social-fundraising -->
    <section class="social-fundraising">
        <div class="container">
            <div class="row">
