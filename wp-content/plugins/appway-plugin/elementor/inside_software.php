 ...
 * @since 1.0.0
 */
class Inside_Software extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Inside Software', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'inside_software',
			[
				'label' => esc_html__( 'Inside Software', 'appway' ),
			]
		);
	...
	$this->start_controls_section(
				'content_section',
				[
					'label' => __( 'services block 1', 'rashid' ),
	...
	$this->start_controls_section(
				'content_section1',
				[
					'label' => __( 'services block 2', 'rashid' ),
					'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
				]
			);
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                                    ...
                                    <div class="feature-block-one js-tilt">
                                        <div class="inner-box">
                                            <div class="hover-content"></div>
                                            <div class="icon-box"><i class="<?php echo esc_attr($item['block_icons1']);?>"></i></div>
                                            <h5><a href="<?php echo esc_url($item['block_btnlink1']['url']);?>"><?php echo wp_kses($item['block_title1'], $allowed_tags);?></a></h5>
