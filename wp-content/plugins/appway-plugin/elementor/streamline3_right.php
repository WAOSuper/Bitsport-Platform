 ...
 * @since 1.0.0
 */
class Streamline3_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_streamline3_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Streamline 3 Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'streamline3_right',
			[
				'label' => esc_html__( 'Streamline 3 Right', 'appway' ),
			]
		);
		$this->add_control(
			'image',
