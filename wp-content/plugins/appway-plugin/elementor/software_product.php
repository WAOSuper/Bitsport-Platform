 ...
 * @since 1.0.0
 */
class Software_Product extends Widget_Base {
	...
	public function get_name() {
		return 'appway_software_product';
	}
	...
	public function get_title() {
		return esc_html__( 'Software Product', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'software_product',
			[
				'label' => esc_html__( 'Software Product', 'appway' ),
			]
		);
    ...
    <!-- software-product -->
    <section class="software-product" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
        <div class="container">
            <div class="row">
