 ...
 * @since 1.0.0
 */
class Increase_Website_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_increase_website_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Increase Website Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Increase Website Left', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
