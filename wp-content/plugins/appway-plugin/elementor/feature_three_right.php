 ...
 * @since 1.0.0
 */
class Feature_Three_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature_three_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Three Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature_three_right_right',
			[
				'label' => esc_html__( 'Feature Three Right Right', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
