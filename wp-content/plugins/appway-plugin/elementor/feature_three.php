 ...
 * @since 1.0.0
 */
class Feature_Three extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature Three', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature_three',
			[
				'label' => esc_html__( 'Feature Three', 'appway' ),
			]
		);
		$this->add_control(
			'title',
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="iamge_block_02">
                                <div class="image-box">
									...
									<figure class="image image-1 wow slideInRight" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
									<?php endif; ?>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="iamge_block_03">
                                <div class="image-box">
									...
									<figure class="image image-1 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
									<?php endif; ?>
									
									<?php if(wp_get_attachment_url($settings['image3']['id'])): ?>
                                    <figure class="image image-2 wow slideInLeft" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></figure>
									<?php endif; ?>
