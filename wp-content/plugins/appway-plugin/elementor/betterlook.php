 ...
 * @since 1.0.0
 */
class Betterlook extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Betterlook', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'betterlook',
			[
				'label' => esc_html__( 'Betterlook', 'appway' ),
			]
		);
    ...
    <!-- betterlook-section -->
    <section class="betterlook-section <?php echo $settings['sec_class'];?>">
	
		<?php if($settings['bgimg']): ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column paroller">
                    <div id="image_block_30">
                        <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
							...
							<figure class="image clearfix"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
							<?php endif; ?>
