 ...
 * @since 1.0.0
 */
class Optimization_Application extends Widget_Base {
	...
	public function get_name() {
		return 'appway_optimization_application';
	}
	...
	public function get_title() {
		return esc_html__( 'Optimization Application', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Optimization Application', 'appway' ),
			]
		);
