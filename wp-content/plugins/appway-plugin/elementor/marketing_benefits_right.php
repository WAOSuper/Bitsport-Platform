 ...
 * @since 1.0.0
 */
class Marketing_Benefits_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_marketing_benefits_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Marketing Benefits Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Marketing Benefits Right', 'appway' ),
			]
		);
    ...
    <!-- marketing-benefits -->
    <section class="marketing-benefits <?php echo $settings['sec_class'];?>">
        <div class="container">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                    <div id="image_block_26">
                        <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
							...
							<figure class="image js-tilt"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
							<?php endif; ?>
