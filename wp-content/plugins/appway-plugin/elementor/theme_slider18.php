 ...
 * @since 1.0.0
 */
class Theme_Slider18 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 18', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider18',
			[
				'label' => esc_html__( 'Theme Slider 18', 'appway' ),
			]
		);	
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
					...
					<div class="image-box js-tilt">
                        <figure class="image"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></figure>
                    </div>
					<?php endif; ?>
