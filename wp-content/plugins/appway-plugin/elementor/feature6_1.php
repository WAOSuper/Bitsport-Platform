 ...
 * @since 1.0.0
 */
class Feature6_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature6 1', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature6_1',
			[
				'label' => esc_html__( 'Feature6 1', 'appway' ),
			]
		);
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                        <div class="image_block_15">
                            <div class="image-box">
                                <figure class="image clearfix wow slideInLeft animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo esc_url($settings['image']['url']);?>" alt="<?php esc_attr_e('Image', 'rashid'); ?>"></figure>
                            </div>
                        </div>
                    </div>
