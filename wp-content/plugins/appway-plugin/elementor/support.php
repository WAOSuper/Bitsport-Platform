...
class Support extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Support', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'support',
			[
				'label' => esc_html__( 'Support', 'appway' ),
			]
		);
        ...
        <div class="container">
            ...
            <div class="inner-box">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 offset-lg-1 image-column">
                        <div class="image_block_23">
                            
							<?php if(wp_get_attachment_url($settings['image']['id'])): ?>
							<div class="image-box js-tilt">
                                <figure class="image wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
                            </div>
							<?php endif; ?>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_23">
							...
							<div class="image-box js-tilt">
                                <figure class="image clearfix wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
                            </div>
							<?php endif; ?>
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content_block_24">
                            <div class="content-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                                ...
                                <div class="btn-box"><a href="<?php echo esc_url($settings['btnlink1']['url']);?>" class="theme-btn"><?php echo $settings['bttn1'];?><i class="fas fa-arrow-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                </div>
