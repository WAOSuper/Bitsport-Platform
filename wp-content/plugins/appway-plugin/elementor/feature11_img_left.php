 ...
 * @since 1.0.0
 */
class Feature11_Img_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature11_img_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature11 Image Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature11_img_left',
			[
				'label' => esc_html__( 'Feature11 Image Left', 'appway' ),
			]
		);
