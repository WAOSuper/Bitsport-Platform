 ...
 * @since 1.0.0
 */
class Subscribe2_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_subscribe2_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Subscribe 2 Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe2_right',
			[
				'label' => esc_html__( 'Subscribe 2 Right', 'appway' ),
			]
		);
    ...
    <!-- subscribe-section -->
    <section class="subscribe-style-two <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                    <div id="image_block_18">
                        <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
							...
							<figure class="image float-bob-y"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
							<?php endif; ?>
