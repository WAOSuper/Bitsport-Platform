 ...
 * @since 1.0.0
 */
class Optimization_Application_Left2 extends Widget_Base {
	...
	public function get_name() {
		return 'appway_optimization_application_left2';
	}
	...
	public function get_title() {
		return esc_html__( 'Optimization Application Left 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Optimization Application Left 2', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
