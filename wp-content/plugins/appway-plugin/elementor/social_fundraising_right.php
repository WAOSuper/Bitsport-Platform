 ...
 * @since 1.0.0
 */
class Social_Fundraising_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_social_fundraising_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Social Fundraising Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Social Fundraising Right', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
