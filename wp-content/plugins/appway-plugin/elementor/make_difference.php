 ...
 * @since 1.0.0
 */
class Make_Difference extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Make Difference', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'make_difference',
			[
				'label' => esc_html__( 'Make Difference', 'appway' ),
			]
		);
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_11">
                        <div class="image-box">
                            <div class="layer-bg" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg1']['id']);?>);"></div>
