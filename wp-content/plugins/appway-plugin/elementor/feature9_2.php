 ...
 * @since 1.0.0
 */
class Feature9_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature9 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature9_2',
			[
				'label' => esc_html__( 'Feature9 2', 'appway' ),
			]
		);
    ...
    <!-- feature-style-ten -->
    <section class="feature-style-ten three">
        <div class="container">
