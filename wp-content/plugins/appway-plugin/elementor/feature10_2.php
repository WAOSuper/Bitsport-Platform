 ...
 * @since 1.0.0
 */
class Feature10_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature10 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature10_2',
			[
				'label' => esc_html__( 'Feature10 2', 'appway' ),
			]
		);
    ...
    <!-- feature-style-11 -->
    <section class="feature-style-11 three <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="inner-content">
                <div class="inner-box">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                            <div class="content_block_34">
