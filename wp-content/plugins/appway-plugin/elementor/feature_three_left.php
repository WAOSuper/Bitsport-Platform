 ...
 * @since 1.0.0
 */
class Feature_Three_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature_three_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Three Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature_three_left',
			[
				'label' => esc_html__( 'Feature Three Left', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
