 ...
 * @since 1.0.0
 */
class Theme_Slider7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 7', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider7',
			[
				'label' => esc_html__( 'Theme Slider 7', 'appway' ),
			]
		);
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
						...
						<figure class="image clearfix"><a href="<?php echo wp_get_attachment_url($settings['image5']['id']);?>" class="lightbox-image"><img src="<?php echo wp_get_attachment_url($settings['image5']['id']);?>" alt="<?php echo $settings['imgtitle5'];?>"></a></figure>
						<?php endif; ?>
