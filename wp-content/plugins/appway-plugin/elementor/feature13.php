 ...
 * @since 1.0.0
 */
class Feature13 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature13', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature13',
			[
				'label' => esc_html__( 'Feature13', 'appway' ),
			]
		);
    ...
    <!-- feature-style-two -->
    <section class="feature-style-two elements centred sec-pad-two">
        <div class="container">
