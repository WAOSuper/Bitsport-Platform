 ...
 * @since 1.0.0
 */
class Theme_Slider2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider2',
			[
				'label' => esc_html__( 'Theme Slider 2', 'appway' ),
			]
		);
            ...
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                    <div class="content-box">
                        <div class="top-text"><?php echo $settings['subtitle'];?></div>
                        <h1><?php echo $settings['title'];?></h1>
                        <div class="text"><?php echo $settings['text'];?></div>
                        <div class="video-box"><a class="html5lightbox" href="<?php echo esc_url($settings['btnlink']['url']);?>" ><?php echo $settings['bttn'];?><i class="flaticon-play-button"></i></a></div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
						...
						<figure class="image image-1 clearfix wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
						<?php endif; ?>
                        ...
                        <figure class="image image-3 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
						<?php endif; ?>
