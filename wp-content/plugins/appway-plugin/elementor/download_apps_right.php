 ...
 * @since 1.0.0
 */
class Download_Apps_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_download_apps_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Download Apps Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'take_download_apps_right',
			[
				'label' => esc_html__( 'Download Apps Right', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
    ...
    <section class="download-apps home-17 <?php echo $settings['sec_class'];?>">
        ...
        <div class="image-layer" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
		<?php else :?>	
		<div class="noimage">
		<?php endif;?>
		</div>
