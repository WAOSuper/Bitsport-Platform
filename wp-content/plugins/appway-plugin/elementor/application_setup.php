 ...
 * @since 1.0.0
 */
class Application_Setup extends Widget_Base {
	...
	public function get_name() {
		return 'appway_application_setup';
	}
	...
	public function get_title() {
		return esc_html__( 'Application Setup', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'application_setup',
			[
				'label' => esc_html__( 'Application Setup', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
    ...
    <!-- application-setup -->
    <section class="application-setup <?php echo esc_attr($settings['sec_class']);?>">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($settings['column'], true );?> col-md-6 col-sm-12 single-column">
                    <div class="single-item wow flipInY" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="count-box"><?php echo wp_kses($item['block_number'], $allowed_tags);?></div>
                        <div class="inner-box">
