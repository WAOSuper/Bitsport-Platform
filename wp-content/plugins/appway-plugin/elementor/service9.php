...
class Service9 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 9', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service9',
			[
				'label' => esc_html__( 'Service 9', 'appway' ),
			]
		);
    ...
    <section class="organization-section centred">
        <div class="container">
            ...
            <div class="more-btn"><a href="<?php echo esc_url($settings['btnlink']['url']);?>" class="theme-btn-two"><?php echo $settings['bttn'];?></a></div>
