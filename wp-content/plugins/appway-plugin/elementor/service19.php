...
class Service19 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 19', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service19',
			[
				'label' => esc_html__( 'Service 19', 'appway' ),
			]
		);			
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		?>
<section class="<?php echo esc_attr($settings['sec_class']);?> best-hosting alternate-2">
	<div class="container">
				...
				<div class="col-lg-<?php echo esc_attr($item['block_column'], true );?> col-md-6 col-sm-12 single-column">
					<div class="single-item wow flipInY" data-wow-delay="00ms" data-wow-duration="1500ms">
						<div class="inner-box">
							...
							<div class="link-btn"><a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><i class="fas fa-long-arrow-alt-right"></i></a></div>
						</div>
					</div>
				</div>
