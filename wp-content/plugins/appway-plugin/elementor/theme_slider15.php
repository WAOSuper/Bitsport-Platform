 ...
 * @since 1.0.0
 */
class Theme_Slider15 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 15', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider15',
			[
				'label' => esc_html__( 'Theme Slider 15', 'appway' ),
			]
		);	
    ...
    <section class="banner-style-15 centred">
        <div class="anim-icons">
            ...
            <div class="icon icon-4"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></div>
			<?php endif; ?>
			
			<?php if(wp_get_attachment_url($settings['image4']['id'])): ?>
            <div class="icon icon-5 rotate-me"><img src="<?php echo wp_get_attachment_url($settings['image4']['id']);?>" alt="<?php echo $settings['imgtitle4'];?>"></div>
			<?php endif; ?>
			
			<?php if(wp_get_attachment_url($settings['image5']['id'])): ?>
            <div class="icon icon-6 rotate-me"><img src="<?php echo wp_get_attachment_url($settings['image5']['id']);?>" alt="<?php echo $settings['imgtitle5'];?>"></div>
			<?php endif; ?>
        ...
        <div class="container">
            <div class="content-box">
                ...
                <div class="btn-box">
                    ...
                    <a href="<?php echo esc_url($settings['btnlink1']['url']);?>" class="html5lightbox video-btn" data-caption=""><?php echo $settings['bttn1'];?><i class="flaticon-play-button"></i></a>
                </div>
            </div>
            
			
			<?php if(wp_get_attachment_url($settings['image6']['id'])): ?>
			<figure class="image-box"><img src="<?php echo wp_get_attachment_url($settings['image6']['id']);?>" alt="<?php echo $settings['imgtitle6'];?>"></figure>
			<?php endif; ?>
