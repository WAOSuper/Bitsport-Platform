 ...
 * @since 1.0.0
 */
class Solution_Text_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_solution_text_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Solution Text Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'solution_text_right',
			[
				'label' => esc_html__( 'Solution Text Right', 'appway' ),
			]
		);
	$this->add_control(
			'title',
