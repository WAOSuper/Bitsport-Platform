 ...
 * @since 1.0.0
 */
class Campaing extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Campaing', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'campaing',
			[
				'label' => esc_html__( 'Campaing', 'appway' ),
			]
		);
    ...
    <!-- campaing-section -->
    <section class="campaing-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                    <div id="content_block_50">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 image-column">
					...
					<div id="image_block_45">
                        <figure class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
                    </div>
					<?php endif; ?>
