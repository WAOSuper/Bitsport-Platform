 ...
 * @since 1.0.0
 */
class Solve_Problem_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_solve_problem_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Solve Problem Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'solve_problem_left',
			[
				'label' => esc_html__( 'Solve Problem Left', 'appway' ),
			]
		);
...
// New Tab#1
    ...
    <section class="solve-problem <?php echo $settings['sec_class'];?>">
        <div class="image-layer wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);"></div>
        <div class="container">
            <div class="row">
