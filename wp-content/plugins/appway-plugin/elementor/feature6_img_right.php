 ...
 * @since 1.0.0
 */
class Feature6_Img_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature6_img_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature 6 Image Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature6_img_right',
			[
				'label' => esc_html__( 'Feature 6 Image Right', 'appway' ),
			]
		);
		$this->add_control(
			'bgimg',
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                        <div class="image_block_14">
                            <div class="image-box">
                                ...
                                <figure class="image image-1 clearfix wow slideInRight animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
								<?php endif; ?>
