 ...
 * @since 1.0.0
 */
class Inside_Software_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_inside_software_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Inside Software Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Inside Software Right', 'appway' ),
			]
		);
		$this->add_control(
              'repeat', 
