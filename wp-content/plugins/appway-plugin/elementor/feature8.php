 ...
 * @since 1.0.0
 */
class Feature8 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature 8', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature8',
			[
				'label' => esc_html__( 'Feature 8', 'appway' ),
			]
		);
    ...
    <section class="feature-style-eight">
        <div class="pattern-bg">
            <div class="pattern-1 wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);"></div>
            <div class="pattern-2 wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg1']['id']);?>);"></div>
        </div>
        <div class="container">
            <div class="inner-box">
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                        <div class="content_block_21">
                            <div class="content-box wow fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
                                <div class="icon-box wow zoomIn animated" data-wow-delay="300ms" data-wow-duration="1500ms"><i class="flaticon-user"></i></div>
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                        <div class="image_block_22">
                            <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
								...
								<figure class="image clearfix js-tilt"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
								<?php endif; ?>
                    ...
                    <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                        <div class="image_block_22">
                            <div class="image-box wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
								 ...
								 <figure class="image clearfix js-tilt"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
								 <?php endif; ?>
