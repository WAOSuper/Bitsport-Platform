 ...
 * @since 1.0.0
 */
class Feature_Three_Right2 extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature_three_right2';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature Three Right 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Feature Three Right 2', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
