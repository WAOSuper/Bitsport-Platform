...
class Service20 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 20', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service20',
			[
				'label' => esc_html__( 'Service 20', 'appway' ),
			]
		);			
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		?>
<section class="<?php echo esc_attr($settings['sec_class']);?> service-style-four">
	<div class="container">
