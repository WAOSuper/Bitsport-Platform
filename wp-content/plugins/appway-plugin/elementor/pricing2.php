 ...
 * @since 1.0.0
 */
class Pricing2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'pricing2',
			[
				'label' => esc_html__( 'Pricing 2', 'appway' ),
			]
		);
    ...
    <!-- pricing-style-two -->
    <section class="pricing-style-two centred <?php echo $settings['sec_class'];?>">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($settings['column'], true );?> col-md-6 col-sm-12 pricing-block">
