 ...
 * @since 1.0.0
 */
class Powerful_Management extends Widget_Base {
	...
	public function get_name() {
		return 'appway_powerful_management';
	}
	...
	public function get_title() {
		return esc_html__( 'Powerful Management', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'powerful_management',
			[
				'label' => esc_html__( 'Powerful Management', 'appway' ),
			]
		);
