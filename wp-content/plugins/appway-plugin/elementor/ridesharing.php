 ...
 * @since 1.0.0
 */
class Ridesharing extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Ridesharing', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'ridesharing',
			[
				'label' => esc_html__( 'Ridesharing', 'appway' ),
			]
		);
    ...
    <!-- ridesharing-section -->
    <section class="ridesharing-section <?php echo $settings['sec_class'];?>">
        <div class="container">
