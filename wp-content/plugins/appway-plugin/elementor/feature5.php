 ...
 * @since 1.0.0
 */
class Feature5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature 5', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature5',
			[
				'label' => esc_html__( 'Feature 5', 'appway' ),
			]
		);
    ...
    <!-- feature-style-four -->
    <section class="feature-style-four one">
        <div class="container">
            <div class="inner-container">
                <div class="inner-box">
                    <div class="row">
                        <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                            <div class="content_block_07">
