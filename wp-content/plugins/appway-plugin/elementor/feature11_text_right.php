 ...
 * @since 1.0.0
 */
class Feature11_Text_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature11_text_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature11 Text Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Feature11 Text Right', 'appway' ),
			]
		);
		$this->add_control(
			'title',
    ...
    <!-- feature-style-12 -->
    <section class="feature-style-12 three">
        <div class="container">
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12 col-sm-12 content-column">
                            <div class="content_block_35">
                                <div class="content-box margin_left_30 wow fadeInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
