 ...
 * @since 1.0.0
 */
class Subscribe2_Left extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Subscribe 2 Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe2_left',
			[
				'label' => esc_html__( 'Subscribe 2 Left', 'appway' ),
			]
		);
