 ...
 * @since 1.0.0
 */
class Website extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Website', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'website',
			[
				'label' => esc_html__( 'Website', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		?>
<section class="<?php echo esc_attr($settings['sec_class']);?> increase-website">
			...
			<div class="col-lg-6 col-md-12 col-sm-12 image-column">
				<div id="image_block_41">
					<div class="image-box paroller">
						...
						<figure class="image image-1"><img src="<?php echo esc_url($settings['image']['url']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
						<?php endif; ?>
						
						<?php if(wp_get_attachment_url($settings['image1']['id'])): ?>
						<figure class="image image-2"><img src="<?php echo esc_url($settings['image1']['url']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
						<?php endif; ?>
						
						<?php if(wp_get_attachment_url($settings['image2']['id'])): ?>
						<figure class="image image-3"><img src="<?php echo esc_url($settings['image2']['url']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
						<?php endif; ?>
