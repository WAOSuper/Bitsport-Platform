 ...
 * @since 1.0.0
 */
class Crm_Programming extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Crm Programming', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'crm_programming',
			[
				'label' => esc_html__( 'Crm Programming', 'appway' ),
			]
		);
                ...
                <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?> col-md-6 col-sm-12 single-column">
                    <div class="single-item wow slideInLeft animated" data-wow-delay="900ms" data-wow-duration="1500ms">
                        <div class="progress-box">
                            <div class="piechart" data-fg-color="<?php echo esc_attr($item['coler']);?>" data-value="<?php echo esc_attr($item['ff_stop']);?>">
