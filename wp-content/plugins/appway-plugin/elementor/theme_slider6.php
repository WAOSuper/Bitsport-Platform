 ...
 * @since 1.0.0
 */
class Theme_Slider6 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 6', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider6',
			[
				'label' => esc_html__( 'Theme Slider 6', 'appway' ),
			]
		);
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
                        <div class="user-thumb">
							...
							<figure class="user user-1"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image1']['id'])): ?>
                            <figure class="user user-2"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image2']['id'])): ?>
                            <figure class="user user-3"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image3']['id'])): ?>
                            <figure class="user user-4"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image4']['id'])): ?>
                            <figure class="user user-5"><img src="<?php echo wp_get_attachment_url($settings['image4']['id']);?>" alt="<?php echo $settings['imgtitle4'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image5']['id'])): ?>
                            <figure class="user user-6"><img src="<?php echo wp_get_attachment_url($settings['image5']['id']);?>" alt="<?php echo $settings['imgtitle5'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image6']['id'])): ?>
                            <figure class="user user-7"><img src="<?php echo wp_get_attachment_url($settings['image6']['id']);?>" alt="<?php echo $settings['imgtitle6'];?>"></figure>
							<?php endif; ?>
							
                        </div>
                        
						<?php if(wp_get_attachment_url($settings['image7']['id'])): ?>
						<figure class="image"><img src="<?php echo wp_get_attachment_url($settings['image7']['id']);?>" alt="<?php echo $settings['imgtitle7'];?>"></figure>
						<?php endif; ?>
