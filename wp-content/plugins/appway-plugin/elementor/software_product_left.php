 ...
 * @since 1.0.0
 */
class Software_Product_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_software_product_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Software Product Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Software Product Left', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
