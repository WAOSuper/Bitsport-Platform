 ...
 * @since 1.0.0
 */
class Feature6_Text_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature6_text_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature 6 Text Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature6_text_left',
			[
				'label' => esc_html__( 'Feature 6 Text Left', 'appway' ),
			]
		);
