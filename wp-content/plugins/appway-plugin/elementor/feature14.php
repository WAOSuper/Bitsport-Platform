 ...
 * @since 1.0.0
 */
class Feature14 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature14', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature14',
			[
				'label' => esc_html__( 'Feature14', 'appway' ),
			]
		);
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div class="iamge_block_02">
                        <div class="image-box">
							...
							<?php if(wp_get_attachment_url($settings['image']['id'])): ?>
                            <figure class="image image-2 wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
							<?php endif; ?>
