 ...
 * @since 1.0.0
 */
class Subscribe8 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Subscribe 8', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe8',
			[
				'label' => esc_html__( 'Subscribe 8', 'appway' ),
			]
		);
	...
	protected function render() {
		...
		?>
	<section class="<?php echo $settings['sec_class'];?> subscribe-style-five home-18">
