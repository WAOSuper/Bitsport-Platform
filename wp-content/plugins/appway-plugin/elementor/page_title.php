...
class Page_Title extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Page Title', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'page_title',
			[
				'label' => esc_html__( 'Page Title', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		?>
	<section class="<?php echo esc_attr($settings['sec_class']);?> page-title" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
        ...
        <div class="container">
            <div class="content-box clearfix">
                ...
                <ul class="bread-crumb pull-right">
                    <li><?php echo $settings['title1'];?></li>
                    <li><a href="<?php echo esc_url($settings['btnlink']['url']);?>"><?php echo $settings['text1'];?></a></li>
                </ul>
            </div>
        </div>
    </section>
