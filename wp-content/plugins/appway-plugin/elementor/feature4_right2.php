 ...
 * @since 1.0.0
 */
class Feature4_Right2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature 4 Right 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature4_right2',
			[
				'label' => esc_html__( 'Feature 4 Right 2', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
