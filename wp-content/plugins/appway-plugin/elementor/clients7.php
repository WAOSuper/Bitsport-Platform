 ...
 * @since 1.0.0
 */
class Clients7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Clients 7', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'clients7',
			[
				'label' => esc_html__( 'Clients 7', 'appway' ),
			]
		);
    ...
    <!-- clients-style-four -->
    <section class="clients-style-four <?php echo $settings['sec_class'];?>">
