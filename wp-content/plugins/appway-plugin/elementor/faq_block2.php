 ...
 * @since 1.0.0
 */
class Faq_Block2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Faq Block 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'faq_block2',
			[
				'label' => esc_html__( 'Faq Block 2', 'appway' ),
			]
		);
			  	...
			  	[
            		...
            		'fields' => 
						[
							...
							[
                    			'name' => 'block_text',
                    			'label' => esc_html__('Block Text', 'emu'),
                    			'type' => Controls_Manager::TEXTAREA,
                    			'default' => ''
                			],
            			],
                    ...
                    <div class="faq-content">
                        ...
                        <ul class="accordion-box">
                            ...
                            <li class="accordion block">
                                <div class="acc-btn <?php if($key == 2) echo 'active';?>">
