 ...
 * @since 1.0.0
 */
class Clients3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Clients 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'clients3',
			[
				'label' => esc_html__( 'Clients 3', 'appway' ),
			]
		);
    ...
    <!-- clients-style-three -->
    <section class="clients-style-three <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="inner-container">
                <div class="clients-carousel-2 owl-carousel owl-theme">
