...
class Service16 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 16', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service16',
			[
				'label' => esc_html__( 'Service 16', 'appway' ),
			]
		);	
    ...
    <section class="ourmission-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?> col-md-12 col-sm-12 single-column">
