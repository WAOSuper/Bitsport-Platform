...
class Service extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service',
			[
				'label' => esc_html__( 'Service', 'appway' ),
			]
		);
    ...
    <section class="service-section">
        <div class="container">
            ...
            <div class="sec-title center">
                <div class="icon-box"><i class="flaticon-shopping-1"></i></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($settings['column'], true );?> col-md-6 col-sm-12 service-block">
