 ...
 * @since 1.0.0
 */
class Feature12_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature12 1', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature12_1',
			[
				'label' => esc_html__( 'Feature12 1', 'appway' ),
			]
		);
    ...
    <!-- feature-style-13 -->
    <section class="feature-style-13 two">
            ...
            <div class="inner-box">
                <div class="row">
                    <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                        <div class="image_block_37">
                            <div class="image-box wow slideInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            ...
                            <div class="content-box wow fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                                ...
                                <div class="lower-content">
                                    ...
                                    <div class="single-item">
                                        ...
                                        <h3><a href="<?php echo esc_url($settings['btnlink']['url']);?>"><?php echo wp_kses($item['block_title'], $allowed_tags);?></a></h3>
