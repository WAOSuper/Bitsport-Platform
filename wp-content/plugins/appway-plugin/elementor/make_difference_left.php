 ...
 * @since 1.0.0
 */
class Make_Difference_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_make_difference_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Make Difference Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Make Difference Left', 'appway' ),
			]
		);
