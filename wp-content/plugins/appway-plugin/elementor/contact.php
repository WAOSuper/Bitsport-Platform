...
class Contact extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Contact', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'contact',
			[
				'label' => esc_html__( 'Contact', 'appway' ),
			]
		);
		...
		$this->add_control(
			'contact_us_form',
			[
				'label'       => __( 'Contact Form 7 Url', 'carecall' ),
				'type'        => Controls_Manager::TEXTAREA,
				'dynamic'     => [
					'active' => true,
				],
				'placeholder' => __( 'Enter your Contact Form 7 Url', 'carecall' ),
				'default'     => __( '', 'carecall' ),
			]
		);
            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-sm-12 offset-lg-1 big-column">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 info-column">
                                <div class="single-info-box">
                                    ...
                                    <div class="phone"><a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><?php echo wp_kses($item['block_subtitle'], $allowed_tags);?></a></div>
                                </div>
                            </div>
					...
					<div class="image-container">
                        <figure class="image-box"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
                    </div>
					<?php endif; ?>
