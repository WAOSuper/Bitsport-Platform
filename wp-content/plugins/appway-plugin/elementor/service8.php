...
class Service8 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 8', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service8',
			[
				'label' => esc_html__( 'Service 8', 'appway' ),
			]
		);
    ...
    <section class="service-style-three">
        <div class="image-layer wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);"></div>
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 single-column">
                        ...
                        <div class="service-block-three wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="link-btn"><a href="<?php echo esc_url($settings['btnlink']['url']);?>"><i class="far fa-arrow-alt-circle-right"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 single-column">
                        ...
                        <div class="service-block-three wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="link-btn"><a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><i class="far fa-arrow-alt-circle-right"></i></a></div>
                            </div>
                        </div>
