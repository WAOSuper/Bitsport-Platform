 ...
 * @since 1.0.0
 */
class Ridesharing2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Ridesharing 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'ridesharing2',
			[
				'label' => esc_html__( 'Ridesharing 2', 'appway' ),
			]
		);
    ...
    <!-- ridesharing-section -->
    <section class="ridesharing-section elements sec-pad-two">
        <div class="container">
