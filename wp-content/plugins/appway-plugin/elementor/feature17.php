 ...
 * @since 1.0.0
 */
class Feature17 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature17', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature17',
			[
				'label' => esc_html__( 'Feature17', 'appway' ),
			]
		);
    ...
    <!-- feature-style-seven -->
    <section class="feature-style-seven elements sec-pad-two">
        <div class="container">
