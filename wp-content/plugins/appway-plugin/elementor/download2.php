 ...
 * @since 1.0.0
 */
class Download2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Download 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'download2',
			[
				'label' => esc_html__( 'Download 2', 'appway' ),
			]
		);
    ...
    <!-- download-apps -->
    <section class="download-apps <?php echo $settings['sec_class'];?>">
        <div class="anim-icons">
            ...
            <div class="icon icon-4 rotate-me"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></div>
			<?php endif; ?>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_16">
                        <div class="image-box">
							...
							<figure class="image image-1 wow slideInLeft" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image4']['id']);?>" alt="<?php echo $settings['imgtitle4'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image5']['id'])): ?>
                            <figure class="image image-2 wow slideInLeft" data-wow-delay="600ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image5']['id']);?>" alt="<?php echo $settings['imgtitle5'];?>"></figure>
							<?php endif; ?>
