...
class Blog4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog 4', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog4',
			[
				'label' => esc_html__( 'Blog 4', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
...
$this->start_controls_section(
    ...
    <!-- news-style-three -->
    <section class="news-style-three <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="sec-title center">
                <h2><?php echo $settings['title'];?></h2>
                <p><?php echo $settings['text'];?> <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php echo $settings['text1'];?></a></p>
            </div>
