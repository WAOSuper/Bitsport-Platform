 ...
 * @since 1.0.0
 */
class Feature6_Text_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature6_text_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature6 Text Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature6_text_right',
			[
				'label' => esc_html__( 'Feature6 Text Right', 'appway' ),
			]
		);
		$this->add_control(
			'title',
