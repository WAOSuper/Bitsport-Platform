 ...
 * @since 1.0.0
 */
class Service7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 7', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service7',
			[
				'label' => esc_html__( 'Service 7', 'appway' ),
			]
		);
    ...
    <!-- dashboard-feature -->
    <section class="dashboard-feature <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 content-column">
                    <div id="content_block_22">
