 ...
 * @since 1.0.0
 */
class Inside_Software_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_inside_software_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Inside Software Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Inside Software Left', 'appway' ),
			]
		);
		$this->add_control(
			'title',
