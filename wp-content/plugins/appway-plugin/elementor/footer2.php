 ...
 * @since 1.0.0
 */
class Footer2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'footer2',
			[
				'label' => esc_html__( 'Footer 2', 'appway' ),
			]
		);
                            ...
                            <div class="contact-widget footer-widget">
                                ...
                                <div class="widget-content">
                                    <ul class="list clearfix">
                                        ...
                                        <li><i class="<?php echo str_replace("fa ", "fas ", esc_attr( $item['block_icons']));?>"></i><?php echo wp_kses($item['block_text'], $allowed_tags);?></li>
										<?php endforeach; ?>
