 ...
 * @since 1.0.0
 */
class Subscribe7_right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_subscribe7_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Subscribe 7 Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe7_right',
			[
				'label' => esc_html__( 'Subscribe 7 Right', 'appway' ),
			]
		);
