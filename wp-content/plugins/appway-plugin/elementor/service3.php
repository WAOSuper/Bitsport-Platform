 ...
 * @since 1.0.0
 */
class Service3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'service3',
			[
				'label' => esc_html__( 'Service 3', 'appway' ),
			]
		);
    ...
    <section class="innovative-idea">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($settings['column'], true );?> col-md-12 col-sm-12 single-column">
                    <div class="single-item">
                        <div class="inner-box">
                            <div class="icon-box wow zoomIn animated" data-wow-delay="00ms" data-wow-duration="1500ms">
