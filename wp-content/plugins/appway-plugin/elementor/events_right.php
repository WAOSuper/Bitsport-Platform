 ...
 * @since 1.0.0
 */
class Events_Right extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Events Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'events_right',
			[
				'label' => esc_html__( 'Events Right', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 inner-column">
                    <div id="video_block_02">
                        <div class="inner-box">
                            ...
                            <div class="video-btn">
                            <a href="<?php echo esc_url($settings['btnlink1']['url']);?>" class="lightbox-image" data-caption=""><i class="fas fa-play"></i></a></div>
                        </div>
                    </div>
                </div>
            </div>
