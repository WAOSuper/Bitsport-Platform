 ...
 * @since 1.0.0
 */
class Theme_Slider3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider3',
			[
				'label' => esc_html__( 'Theme Slider 3', 'appway' ),
			]
		);
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                    <div class="image-box">
						...
						<figure class="image image-1 float-bob-x"><img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
						<?php endif; ?>
                        ...
                        <figure class="image image-3"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
						<?php endif; ?>
						
						<?php if(wp_get_attachment_url($settings['image3']['id'])): ?>
                        <figure class="image image-4 float-bob-y"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></figure>
						<?php endif; ?>
						
						<?php if(wp_get_attachment_url($settings['image4']['id'])): ?>
                        <figure class="image image-5"><img src="<?php echo wp_get_attachment_url($settings['image4']['id']);?>" alt="<?php echo $settings['imgtitle4'];?>"></figure>
						<?php endif; ?>
