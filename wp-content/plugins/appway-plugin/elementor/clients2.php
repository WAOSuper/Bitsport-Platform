 ...
 * @since 1.0.0
 */
class Clients2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Clients 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'clients2',
			[
				'label' => esc_html__( 'Clients 2', 'appway' ),
			]
		);
    ...
    <!-- clients-style-two -->
    <section class="clients-style-two <?php echo $settings['sec_class'];?>">
        <div class="container">
