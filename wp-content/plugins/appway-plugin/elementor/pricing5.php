 ...
 * @since 1.0.0
 */
class Pricing5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Pricing 5', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'pricing5',
			[
				'label' => esc_html__( 'Pricing 5', 'appway' ),
			]
		);
    ...
    <!-- pricing-style-four -->
    <section class="pricing-style-four home-15 <?php echo $settings['sec_class'];?>">
        <div class="container">
