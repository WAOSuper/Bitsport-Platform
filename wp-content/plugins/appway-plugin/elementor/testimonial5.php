 ...
 * @since 1.0.0
 */
class Testimonial5 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonial 5', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonial5',
			[
				'label' => esc_html__( 'Testimonial 5', 'appway' ),
			]
		);	
    ...
    <section class="testimonial-style-five" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
        <div class="pattern-layer1" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg1']['id']);?>);"></div>
        <div class="pattern-layer2" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg2']['id']);?>);"></div>
        <div class="container">
            <div class="sec-title">
