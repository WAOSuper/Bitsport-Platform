 ...
 * @since 1.0.0
 */
class Security_Invisible extends Widget_Base {
	...
	public function get_name() {
		return 'appway_security_invisible';
	}
	...
	public function get_title() {
		return esc_html__( 'Security Invisible', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'security_invisible',
			[
				'label' => esc_html__( 'Security Invisible', 'appway' ),
			]
		);
