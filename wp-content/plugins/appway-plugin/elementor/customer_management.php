 ...
 * @since 1.0.0
 */
class Customer_Management extends Widget_Base {
	...
	public function get_name() {
		return 'appway_customer_management';
	}
	...
	public function get_title() {
		return esc_html__( 'Customer Management', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'customer_management',
			[
				'label' => esc_html__( 'Customer Management', 'appway' ),
			]
		);
