 ...
 * @since 1.0.0
 */
class Streamline4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Streamline4', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'streamline4',
			[
				'label' => esc_html__( 'Streamline4', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
	...
	protected function render() {
		...
		?>
<section class="<?php echo esc_attr($settings['sec_class']);?> streamline-section">
	<div class="container">
