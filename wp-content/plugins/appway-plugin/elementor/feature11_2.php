 ...
 * @since 1.0.0
 */
class Feature11_2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature11 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature11_2',
			[
				'label' => esc_html__( 'Feature11 2', 'appway' ),
			]
		);
