...
class Events extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Events', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'events',
			[
				'label' => esc_html__( 'Events', 'appway' ),
			]
		);
    ...
    <!-- events-section -->
    <section class="events-section <?php echo $settings['sec_class'];?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div id="content_block_52">
                        <div class="content-box">
                            ...
                            <div class="events-slide">
                                ...
                                <div class="single-item">
                                    <div class="inner-box">
                                        <div class="date"><?php echo wp_kses($item['block_date'], $allowed_tags);?></div>
                    ...
                    <div id="video_block_02">
                        <div class="inner-box">
                            ...
                            <figure class="image-box">
								...
								<img src="<?php echo wp_get_attachment_url($settings['image']['id']);?>" alt="<?php echo $settings['imgtitle'];?>">
								<?php endif; ?>
								
                            </figure>
                            <div class="video-btn">
                            	<a href="<?php echo esc_url($settings['btnlink1']['url']);?>" target="_blank"><i class="fas fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
