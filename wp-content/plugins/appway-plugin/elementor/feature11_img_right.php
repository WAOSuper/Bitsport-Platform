 ...
 * @since 1.0.0
 */
class Feature11_Img_Right extends Widget_Base {
	...
	public function get_name() {
		return 'appway_feature11_img_right';
	}
	...
	public function get_title() {
		return esc_html__( 'Feature11 Image Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature11_img_right',
			[
				'label' => esc_html__( 'Feature11 Image Right', 'appway' ),
			]
		);
