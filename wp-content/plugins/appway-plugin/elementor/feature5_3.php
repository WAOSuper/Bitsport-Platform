 ...
 * @since 1.0.0
 */
class Feature5_3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature5 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature5_3',
			[
				'label' => esc_html__( 'Feature5 3', 'appway' ),
			]
		);
    ...
    <!-- feature-style-four -->
    <section class="feature-style-four four">
        <div class="container">
            <div class="inner-container">
                <div class="inner-box">
                    <div class="row">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_10">
