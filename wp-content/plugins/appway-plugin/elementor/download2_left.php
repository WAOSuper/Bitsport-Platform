 ...
 * @since 1.0.0
 */
class Download2_Left extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Download 2 Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'download2_left',
			[
				'label' => esc_html__( 'Download 2 Left', 'appway' ),
			]
		);
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 image-column">
                    <div id="image_block_16">
                        <div class="image-box">
                            ...
                            <figure class="image image-1 wow slideInLeft" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
							<?php endif; ?>
							
							<?php if(wp_get_attachment_url($settings['image2']['id'])): ?>
                            <figure class="image image-2 wow slideInLeft" data-wow-delay="600ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image2']['id']);?>" alt="<?php echo $settings['imgtitle2'];?>"></figure>
							<?php endif; ?>
