 ...
 * @since 1.0.0
 */
class Feature9_3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature9 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature9_3',
			[
				'label' => esc_html__( 'Feature9 3', 'appway' ),
			]
		);
    ...
    <!-- feature-style-ten -->
    <section class="feature-style-ten four">
        <div class="container">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_28">
                                <div class="image-box">
									...
									<figure class="image clearfix wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image3']['id']);?>" alt="<?php echo $settings['imgtitle3'];?>"></figure>
									<?php endif; ?>
