 ...
 * @since 1.0.0
 */
class Download2_Right extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Download 2 Right', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'download2_right',
			[
				'label' => esc_html__( 'Download 2 Right', 'appway' ),
			]
		);
		$this->add_control(
			'sec_class',
