 ...
 * @since 1.0.0
 */
class Feature9_1 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Feature9 1', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'feature9_1',
			[
				'label' => esc_html__( 'Feature9 1', 'appway' ),
			]
		);
    ...
    <!-- feature-style-ten -->
    <section class="feature-style-ten two">
        <div class="container">
