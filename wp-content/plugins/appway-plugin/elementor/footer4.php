 ...
 * @since 1.0.0
 */
class Footer4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer 4', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'footer4',
			[
				'label' => esc_html__( 'Footer 4', 'appway' ),
			]
		);
                    ...
                    <div class="row">
                        <div class="col-lg-<?php echo esc_attr($settings['number']);?> col-md-6 col-sm-12 footer-column">
                            <div class="about-widget footer-widget">
								...
								<?php if(wp_get_attachment_url($settings['image']['id'])): ?>
								<figure class="footer-logo"><a href="index.html"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></a></figure>
								<?php endif; ?>
