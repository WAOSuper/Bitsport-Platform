 ...
 * @since 1.0.0
 */
class Transactions_Work extends Widget_Base {
	...
	public function get_name() {
		return 'appway_transactions_work';
	}
	...
	public function get_title() {
		return esc_html__( 'Transactions Work', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'transactions_work',
			[
				'label' => esc_html__( 'Transactions Work', 'appway' ),
			]
		);
