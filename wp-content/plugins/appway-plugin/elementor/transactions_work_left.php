 ...
 * @since 1.0.0
 */
class Transactions_Work_Left extends Widget_Base {
	...
	public function get_name() {
		return 'appway_transactions_work_left';
	}
	...
	public function get_title() {
		return esc_html__( 'Transactions Work Left', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Transactions Work Left', 'appway' ),
			]
		);
