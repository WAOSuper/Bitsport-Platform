 ...
 * @since 1.0.0
 */
class Funfacts4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Funfacts 4', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'funfacts4',
			[
				'label' => esc_html__( 'Funfacts 4', 'appway' ),
			]
		);
            ...
            <div class="row">
                ...
                <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?> col-md-6 col-sm-12 counter-block">
                    <div class="inner-box wow zoomIn animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="layer-bg" style="background-image: url(<?php echo wp_get_attachment_url($item['block_bgimg']['id']);?>);"></div>
