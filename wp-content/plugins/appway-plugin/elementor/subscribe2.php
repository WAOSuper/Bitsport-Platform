 ...
 * @since 1.0.0
 */
class Subscribe2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Subscribe 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'subscribe2',
			[
				'label' => esc_html__( 'Subscribe 2', 'appway' ),
			]
		);
