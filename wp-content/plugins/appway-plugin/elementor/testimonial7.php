 ...
 * @since 1.0.0
 */
class Testimonial7 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Testimonial 7', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'testimonial7',
			[
				'label' => esc_html__( 'Testimonial 7', 'appway' ),
			]
		);	
    ...
    <section class="testimonial-style-seven" style="background-image: url(<?php echo wp_get_attachment_url($settings['bgimg']['id']);?>);">
        <div class="container">
            <div class="row">
