 ...
 * @since 1.0.0
 */
class Theme_Slider8 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Slider 8', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'theme_slider8',
			[
				'label' => esc_html__( 'Theme Slider 8', 'appway' ),
			]
		);
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 image-column">
                    <div class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms">
						...
						<figure class="image-1 clearfix"><img src="<?php echo esc_url($settings['image']['url']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
						<?php endif; ?>
						
						
						<?php if(wp_get_attachment_url($settings['image1']['id'])): ?>
                        <figure class="image-2 float-bob-x"><img src="<?php echo esc_url($settings['image1']['url']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
						<?php endif; ?>
