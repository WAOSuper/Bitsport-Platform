 ...
 * @since 1.0.0
 */
class Increase_Website extends Widget_Base {
	...
	public function get_name() {
		return 'appway_increase_website';
	}
	...
	public function get_title() {
		return esc_html__( 'Increase Website', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'increase_website',
			[
				'label' => esc_html__( 'Increase Website', 'appway' ),
			]
		);
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                    <div id="image_block_41">
                        <div class="image-box paroller">
                            ...
                            <figure class="image image-2"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle1'];?>"></figure>
							<?php endif; ?>
