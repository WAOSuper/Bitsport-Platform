 ...
 * @since 1.0.0
 */
class Streamline2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Streamline 2', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'streamline2',
			[
				'label' => esc_html__( 'Streamline 2', 'appway' ),
			]
		);
    ...
    <!-- streamline-section -->
    <section class="sec-pad-two elements">
        <div class="container">
