 ...
 * @since 1.0.0
 */
class Rider3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Rider 3', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'rider3',
			[
				'label' => esc_html__( 'Rider 3', 'appway' ),
			]
		);
	...
	protected function render() {
	    ...
	    <!-- rider-section -->
    <section class="rider-section elements sec-pad-two">
        <div class="container">
            <div class="row align-items-center">
				...
				<div class="col-lg-7 col-md-12 col-sm-12 image-column">
					...
					<div class="image_block_39">
						<figure class="image-box wow slideInRight" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($settings['image1']['id']);?>" alt="<?php echo $settings['imgtitle'];?>"></figure>
					</div>
					<?php endif; ?>
