 ...
 * @since 1.0.0
 */
class Footer3_Address extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Footer 3 Address', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'footer3_address',
			[
				'label' => esc_html__( 'Footer 3 Address', 'appway' ),
			]
		);
