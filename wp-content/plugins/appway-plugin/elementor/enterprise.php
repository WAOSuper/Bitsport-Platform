 ...
 * @since 1.0.0
 */
class Enterprise extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Enterprise', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'enterprise',
			[
				'label' => esc_html__( 'Enterprise', 'appway' ),
			]
		);
                ...
                <div class="col-lg-<?php echo esc_attr($settings['column'], true );?> col-md-6 col-sm-12 single-column">
                    <div class="single-item wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
							...
							<figure class="image-box wow slideInLeft" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo wp_get_attachment_url($item['block_image']['id']);?>" alt="<?php echo wp_kses($item['block_imgtitle'], $allowed_tags);?>"></figure>
							<?php endif; ?>
