 ...
 * @since 1.0.0
 */
class Managed_Wordpress extends Widget_Base {
	...
	public function get_name() {
		return 'appway_managed_wordpress';
	}
	...
	public function get_title() {
		return esc_html__( 'Managed Wordpress', 'appway' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'managed_wordpress',
			[
				'label' => esc_html__( 'Managed Wordpress', 'appway' ),
			]
		);
