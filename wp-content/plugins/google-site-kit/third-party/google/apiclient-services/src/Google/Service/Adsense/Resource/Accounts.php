 ...
 *  </code>
 */
class Google_Service_Adsense_Resource_Accounts extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($name, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_Account");
    }
    /**
    ...
    public function listAccounts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListAccountsResponse");
    }
    /**
    ...
    public function listChildAccounts($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('listChildAccounts', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListChildAccountsResponse");
    }
}
