 ...
 * the License.
 */
class Google_Service_PeopleService_BatchUpdateContactsResponse extends \Google\Site_Kit_Dependencies\Google_Model
{
    protected $updateResultType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_PersonResponse';
