 ...
 *  </code>
 */
class Google_Service_PeopleService_Resource_ContactGroups extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function batchGet($optParams = array())
    {
        ...
        return $this->call('batchGet', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_BatchGetContactGroupsResponse");
    }
    /**
     ...
     */
    public function create(\Google\Site_Kit_Dependencies\Google_Service_PeopleService_CreateContactGroupRequest $postBody, $optParams = array())
    {
        $params = array('postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('create', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroup");
    }
    /**
    ...
    public function delete($resourceName, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('delete', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_PeopleEmpty");
    }
    /**
    ...
    public function get($resourceName, $optParams = array())
    {
        $params = array('resourceName' => $resourceName);
        $params = \array_merge($params, $optParams);
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroup");
    }
    /**
    ...
    public function listContactGroups($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ListContactGroupsResponse");
    }
    /**
     ...
     * @return Google_Service_PeopleService_ContactGroup
     */
    public function update($resourceName, \Google\Site_Kit_Dependencies\Google_Service_PeopleService_UpdateContactGroupRequest $postBody, $optParams = array())
    {
        $params = array('resourceName' => $resourceName, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('update', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ContactGroup");
    }
}
