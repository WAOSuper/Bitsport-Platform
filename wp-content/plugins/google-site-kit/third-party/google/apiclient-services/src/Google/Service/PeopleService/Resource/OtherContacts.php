...
class Google_Service_PeopleService_Resource_OtherContacts extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    ...
    public function listOtherContacts($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_ListOtherContactsResponse");
    }
    /**
    ...
    public function search($optParams = array())
    {
        $params = array();
        $params = \array_merge($params, $optParams);
        return $this->call('search', array($params), "Google\Site_Kit_Dependencies\Google_Service_PeopleService_SearchResponse");
    }
}
