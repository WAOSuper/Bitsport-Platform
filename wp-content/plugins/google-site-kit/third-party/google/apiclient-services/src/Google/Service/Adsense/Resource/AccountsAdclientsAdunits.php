 ...
 *  </code>
 */
class Google_Service_Adsense_Resource_AccountsAdclientsAdunits extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function get($name, $optParams = array())
    {
        ...
        return $this->call('get', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_AdUnit");
    }
    /**
    ...
    public function getAdcode($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = \array_merge($params, $optParams);
        return $this->call('getAdcode', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_AdUnitAdCode");
    }
    /**
    ...
    public function listAccountsAdclientsAdunits($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListAdUnitsResponse");
    }
    /**
    ...
    public function listLinkedCustomChannels($parent, $optParams = array())
    {
        $params = array('parent' => $parent);
        $params = \array_merge($params, $optParams);
        return $this->call('listLinkedCustomChannels', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListLinkedCustomChannelsResponse");
    }
}
