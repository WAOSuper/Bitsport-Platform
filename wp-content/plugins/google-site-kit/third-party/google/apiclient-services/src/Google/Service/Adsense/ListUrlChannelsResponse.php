 ...
 * the License.
 */
class Google_Service_Adsense_ListUrlChannelsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'urlChannels';
    public $nextPageToken;
    protected $urlChannelsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_UrlChannel';
