 ...
 * the License.
 */
class Google_Service_Adsense_ListAdClientsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'adClients';
    protected $adClientsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_AdClient';
