 ...
 *  </code>
 */
class Google_Service_Adsense_Resource_AccountsReportsSaved extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function generate($name, $optParams = array())
    {
        ...
        return $this->call('generate', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ReportResult");
    }
    /**
    ...
    public function generateCsv($name, $optParams = array())
    {
        $params = array('name' => $name);
        $params = \array_merge($params, $optParams);
        return $this->call('generateCsv', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_HttpBody");
    }
    /**
    ...
    public function listAccountsReportsSaved($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListSavedReportsResponse");
    }
}
