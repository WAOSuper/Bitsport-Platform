 ...
 * the License.
 */
class Google_Service_Adsense_ListLinkedAdUnitsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'adUnits';
    protected $adUnitsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_AdUnit';
