 ...
 *  </code>
 */
class Google_Service_Ideahub_Resource_PlatformsPropertiesIdeaStates extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
     ...
     */
    public function patch($name, \Google\Site_Kit_Dependencies\Google_Service_Ideahub_GoogleSearchIdeahubV1alphaIdeaState $postBody, $optParams = array())
    {
        $params = array('name' => $name, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
        return $this->call('patch', array($params), "Google\Site_Kit_Dependencies\Google_Service_Ideahub_GoogleSearchIdeahubV1alphaIdeaState");
    }
}
