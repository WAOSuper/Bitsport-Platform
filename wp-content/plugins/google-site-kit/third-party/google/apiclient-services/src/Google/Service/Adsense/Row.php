 ...
 * the License.
 */
class Google_Service_Adsense_Row extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'cells';
    protected $cellsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_Cell';
