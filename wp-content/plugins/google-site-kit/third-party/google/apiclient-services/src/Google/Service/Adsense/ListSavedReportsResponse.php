 ...
 * the License.
 */
class Google_Service_Adsense_ListSavedReportsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'savedReports';
    public $nextPageToken;
    protected $savedReportsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_SavedReport';
