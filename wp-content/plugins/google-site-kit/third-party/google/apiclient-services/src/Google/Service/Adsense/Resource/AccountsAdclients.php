 ...
 *  </code>
 */
class Google_Service_Adsense_Resource_AccountsAdclients extends \Google\Site_Kit_Dependencies\Google_Service_Resource
{
    /**
    ...
    public function getAdcode($name, $optParams = array())
    {
        ...
        return $this->call('getAdcode', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_AdClientAdCode");
    }
    /**
    ...
    public function listAccountsAdclients($parent, $optParams = array())
    {
        ...
        $params = \array_merge($params, $optParams);
        return $this->call('list', array($params), "Google\Site_Kit_Dependencies\Google_Service_Adsense_ListAdClientsResponse");
    }
}
