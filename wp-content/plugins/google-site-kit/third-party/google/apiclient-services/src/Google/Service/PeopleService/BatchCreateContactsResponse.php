 ...
 * the License.
 */
class Google_Service_PeopleService_BatchCreateContactsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'createdPeople';
    protected $createdPeopleType = 'Google\Site_Kit_Dependencies\Google_Service_PeopleService_PersonResponse';
