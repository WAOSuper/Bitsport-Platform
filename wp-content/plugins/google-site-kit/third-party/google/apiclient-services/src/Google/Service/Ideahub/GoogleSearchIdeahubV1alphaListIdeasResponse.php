 ...
 * the License.
 */
class Google_Service_Ideahub_GoogleSearchIdeahubV1alphaListIdeasResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'ideas';
    protected $ideasType = 'Google\Site_Kit_Dependencies\Google_Service_Ideahub_GoogleSearchIdeahubV1alphaIdea';
