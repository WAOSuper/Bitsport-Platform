 ...
 * the License.
 */
class Google_Service_Adsense_ListLinkedCustomChannelsResponse extends \Google\Site_Kit_Dependencies\Google_Collection
{
    protected $collection_key = 'customChannels';
    protected $customChannelsType = 'Google\Site_Kit_Dependencies\Google_Service_Adsense_CustomChannel';
